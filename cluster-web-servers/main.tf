...
resource "aws_autoscaling_group" "web-elb" {
  launch_configuration = "${aws_launch_configuration.web-elb.id}"
...
resource "aws_launch_configuration" "web-elb" {
  # AWS Linux AMI 2018.03.0 (HVM), SSD Volume Type in us-east-2
...
resource "aws_security_group" "instance" {
  name = "terraform-web-elb-instance"
